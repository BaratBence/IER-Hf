...
public class Recipes {
	...
	public Recipes()
	{
		...
		Book.add(new Recipe("SoupA",SoupA,true,20,false,0,2));
		...
		Book.add(new Recipe("SoupB",SoupB,true,10,false,0,4));
		...
		Book.add(new Recipe("MainA",MainA,true,40,false,0,6));
		...
		Book.add(new Recipe("MainB",MainB,false,0,true,50,6));
